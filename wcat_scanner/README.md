...
A11yWatch is much more detailed, feature-rich, and faster, than A11yWatch Lite. [Sign up](https://scanner.wcat.dev) for A11yWatch for free today. We offer high performance API
...
[A11yWatch Cloud](https://scanner.wcat.dev) is the fastest way to get started with A11yWatch. It provides managed infrastructure as well as an instant and free access for development projects and concepts.
...
```
hyperfine 'a11ywatch scan -u https://scanner.wcat.dev' 

Benchmark 1: a11ywatch scan -u https://scanner.wcat.dev
...
```
hyperfine 'a11ywatch crawl -u https://scanner.wcat.dev' 

Benchmark 1: a11ywatch crawl -u https://scanner.wcat.dev
