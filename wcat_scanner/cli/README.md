...
a11ywatch scan --url https://scanner.wcat.dev > results.json
# scan a url and attempt to fix code based on recommendations [installs the fast ripgrep crate for search].
a11ywatch scan --url https://scanner.wcat.dev --fix
# scan a website multi page and pipe the stdout to a file.
a11ywatch crawl --url https://scanner.wcat.dev > results.json
# scan a website multi page and include subdomains.
a11ywatch crawl --url https://scanner.wcat.dev -S > results.json
# scan a website multi page and include subdomains and all TLD extensions.
a11ywatch crawl --url https://scanner.wcat.dev -S -t > results.json
# scan a website multi page and get results parsed as checklist
a11ywatch crawl --url https://scanner.wcat.dev -d -n -s && a11ywatch --results-parsed-list
```
